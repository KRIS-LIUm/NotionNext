...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '刘漫章', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个正在找工作的小女孩', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://manzhangliu.com', // 网站地址
